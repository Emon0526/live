	...
	return (function (e) {
		...
		function (e, t, n) {
			...
			var r = n(4),
				...
				l = n(5),
				s = i(l)
			a.call(s.default, navigator.userAgent),
				...
				(0, u.default)(s.default, {
					...
					getStyle: function (e, t) {
						...
						return i && i.getComputedStyle
							? ((t = t.replace(/([A-Z])/g, '-$1').toLowerCase()), i.getComputedStyle(e, null).getPropertyValue(t))
							: e.currentStyle
	...
	*/
							...
							a &&
								r.push.apply(
									...
									a[t]
										...
										: '' + a === a
										? /</.test(a)
											? (((o = e.createElement(o || t)).innerHTML = a), o.children)
											: o
											? (o = i(o)[0])
												? o[n](a)
												: r
		...
		function (e, t, n) {
			...
			function a() {
				var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : '',
					...
					n = arguments[2]
				return 'object' === ('undefined' == typeof t ? 'undefined' : o(t)) && ((n = t), (t = u.default.noop)), (n = u.default.extend({content: e, buttons: [{label: '确定', type: 'primary', onClick: t}]}, n)), (0, s.default)(n)
			}
			Object.defineProperty(t, '__esModule', {value: !0})
			var o =
					'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
		...
		function (e, t, n) {
			...
			function a() {
				var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : '',
					...
					i = arguments[3]
				return (
					'object' === ('undefined' == typeof t ? 'undefined' : o(t)) ? ((i = t), (t = u.default.noop)) : 'object' === ('undefined' == typeof n ? 'undefined' : o(n)) && ((i = n), (n = u.default.noop)),
					(i = u.default.extend(
						{
							content: e,
							buttons: [
		...
		function (e, t, n) {
			...
			function a() {
				function e(t) {
					;(e = r.default.noop),
						d.addClass(a.isAndroid ? 'weui-animate-fade-out' : 'weui-animate-slide-down'),
				...
				a = r.default.extend({menus: n, actions: i, title: '', className: '', isAndroid: o, onClose: r.default.noop, onClickMask: r.default.noop}, a)
				...
				return (
					...
					d.addClass(a.isAndroid ? 'weui-animate-fade-in' : 'weui-animate-slide-up'),
		...
		function (e, t, n) {
			...
			function a(e, t) {
				...
				if (
					...
					t.compress !== !1 && (t.compress = r.default.extend({width: 1600, height: 1600, quality: 0.8}, t.compress)),
					t.onBeforeQueued)
				) {
			...
			function r(e, t, n) {
				...
				switch ((n > 4 && ((e.width = a), (e.height = i)), n)) {
					...
					case 5:
						...
						break
					case 6:
						t.rotate(0.5 * Math.PI), t.translate(0, -a)
						break
					case 7:
						t.rotate(0.5 * Math.PI), t.translate(i, -a), t.scale(-1, 1)
						break
					case 8:
				...
				;(l.onload = function (l) {
					...
					;(s.onload = function () {
						var l = n(s),
							...
							_ = void 0
						if (
							(v < m && m > h ? ((v = parseInt((h * s.width) / s.height)), (m = h)) : v >= m && v > p && ((m = parseInt((p * s.height) / s.width)), (v = p)),
							(f.width = v),
							(f.height = m),
							d > 0 && r(f, c, d),
							c.drawImage(s, 0, 0, v, m / l),
							(_ = /image\/jpeg/.test(e.type) || /image\/jpg/.test(e.type) ? f.toDataURL('image/jpeg', t.compress.quality) : f.toDataURL(e.type)),
							'file' == t.type)
						)
		...
		function (e, t, n) {
			...
			function o(e) {
				'object' != ('undefined' == typeof e ? 'undefined' : l(e)) && (e = {label: e, value: e}), d.default.extend(this, e)
			}
			function r() {
				function e() {
				...
				function i(e, t) {
					if (void 0 === p[t] && r.defaultValue && void 0 !== r.defaultValue[t]) {
						var n = r.defaultValue[t],
							a = 0,
							u = e.length
						if ('object' == l(e[a])) for (; a < u && n != e[a].value; ++a);
						else for (; a < u && n != e[a]; ++a);
						a < u && (p[t] = a)
					}
					v.find('.weui-picker__group')
						.eq(t)
						.scroll({
							items: e,
							temp: p[t],
				...
				var a = arguments[arguments.length - 1],
					r = d.default.extend({id: 'default', className: '', container: 'body', title: '', desc: '', onChange: d.default.noop, onConfirm: d.default.noop, onClose: d.default.noop}, a),
					u = void 0,
					s = !1
			...
			function u(e) {
				var t = new Date(),
					n = d.default.extend(
						{id: 'datePicker', onChange: d.default.noop, onConfirm: d.default.noop, start: t.getFullYear() - 20, end: t.getFullYear() + 20, defaultValue: [t.getFullYear(), t.getMonth() + 1, t.getDate()], cron: '* * *'},
						e
					)
				'number' == typeof n.start ? (n.start = new Date(n.start + '/01/01')) : 'string' == typeof n.start && (n.start = new Date(n.start.replace(/-/g, '/'))),
					'number' == typeof n.end ? (n.end = new Date(n.end + '/12/31')) : 'string' == typeof n.end && (n.end = new Date(n.end.replace(/-/g, '/')))
				...
				do {
					...
					h || ((h = {label: s + '月', value: s, children: []}), p.children.push(h)), h.children.push({label: f + '日', value: f})
				} while (!u.done)
				return r(a, n)
			}
			Object.defineProperty(t, '__esModule', {value: !0})
		...
		function (e, t, n) {
			...
			r.default.fn.scroll = function (e) {
				...
				var o = this,
					p = r.default.extend({items: [], scrollable: '.weui-picker__content', offset: 2, rowHeight: 48, onChange: r.default.noop, temp: null, bodyHeight: 240}, e),
					h = p.items
						.map(function (e) {
				...
				var C = function (e) {
					...
					;(y = (p.offset - i) * p.rowHeight), u(m, 0.3), l(m, y), p.onChange.call(o, p.items[i], i)
				}
				m = v
					.offAll()
		...
		function (e, t, n) {
			...
			function a(e) {
				...
				return (
					(0, r.default)('body').append(a),
					a.find('.weui-gallery__img').on('click', function () {
						n()
					}),
					a.find('.weui-gallery__del').on('click', function () {
						i.onDelete.call(this, e)
					}),
					a.show().addClass('weui-animate-fade-in'),
					(s = a[0]),
					(s.hide = n),
					s
				)
		...
		function (e, t, n) {
			...
			function a(e) {
				var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
					n = (0, r.default)(e)
				if (((t = r.default.extend({step: void 0, defaultValue: 0, onChange: r.default.noop}, t)), void 0 !== t.step && ((t.step = parseFloat(t.step)), !t.step || t.step < 0)))
